...
| [`docs/VERSIONS.md`](../docs/VERSIONS.md) | Registro: qué tiene 1.0 / 2.0 / cursos, Play |
| [`docs/APP_REVIEW.md`](../docs/APP_REVIEW.md) | Hilo Apple: mensajes, replies, qué no decir, próximo texto |
...
3. Si falta contexto: *“Leé agent/CONTEXT.md, agent/RULES.md, docs/APP_REVIEW.md y docs/VERSIONS.md”*.
...
- Hilo Apple: [`docs/APP_REVIEW.md`](../docs/APP_REVIEW.md).
- Versiones / Play: [`docs/VERSIONS.md`](../docs/VERSIONS.md).
